                        ...
                        <div class="card mb-7 event-filter-card">
                            <div class="card-body py-4">
                                ...
                                <?php if ($activeFilterCount > 0): ?>
                                    <div class="mt-4">
                                        <a href="event-list.php" class="btn btn-sm btn-light-danger rounded-pill px-5">Clear Filters</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <?php else: ?>
                                <div class="col-12">
                                    <div class="event-empty-state text-center p-10 bg-light">
                                        ...
                                        <a href="event-list.php" class="btn btn-light-primary rounded-pill px-6">Reset View</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>

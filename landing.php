	...
	<nav class="navbar-landing">
		<div class="container d-flex justify-content-between align-items-center">
			...
			<div class="d-flex gap-2">
				<a href="index.php" class="btn btn-signin">Sign In</a>
	...
	<section class="hero-section" id="hero">
		<div class="container">
			...
			<div class="d-flex justify-content-center gap-3">
				<a href="register.php" class="btn btn-primary-landing">Get Started</a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 mb-4">
					<h5>Contact</h5>
					<ul class="footer-links">
						<li><i class="fas fa-envelope me-2" style="color:#3699ff;"></i> support@sirimace.com</li>

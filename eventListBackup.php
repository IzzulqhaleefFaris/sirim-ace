...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
                                                            ...
                                                            while ($row = $res->fetch_assoc()) {
                                                                echo "<tr>
                                                                        ...
                                                                        <td>                                                 
                                                                            ...
                                                                            <button 
                                                                                type='button' class='btn btn-sm btn-danger btn-delete' data-id='" . ((int)$row['event_id']) . "' title='Delete'><i class='bi bi-trash'></i>
                                                                            </button>
                                                                        </td>
                                                                    </tr>";
                                                                $i++;
    ...
    <script>
        document.addEventListener("click", function(e) {
            ...
            const idAttr = (btn.dataset && btn.dataset.id) ? btn.dataset.id : btn.getAttribute('data-id');
            console.log("delete idAttr:", idAttr, "btn:", btn); // debug

            const id = Number(String(idAttr ?? '').trim()); // robust parse
